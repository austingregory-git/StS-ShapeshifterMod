...
import StSShapeShifter.patches.relics.BottledPlaceholderField;
import StSShapeShifter.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static StSShapeShifter.ShapeshifterMod.makeRelicOutlinePath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = ShapeshifterMod.makeID("BottledPlaceholderRelic");
