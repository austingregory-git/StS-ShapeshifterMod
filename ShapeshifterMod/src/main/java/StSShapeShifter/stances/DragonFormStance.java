...
public class DragonFormStance extends AbstractStance {
    public static final String STANCE_ID = "DragonFormStance";
    private static final StanceStrings stanceString;
    private static long sfxId;
    private final AbstractPlayer owner;
    private final int amount;

    public DragonFormStance() {
        this.ID = STANCE_ID;
        this.name = STANCE_ID;
        //this.name = null;
    ...
    static {
        stanceString = CardCrawlGame.languagePack.getStanceString("DragonFormStance");
        sfxId = -1L;
    }
}
