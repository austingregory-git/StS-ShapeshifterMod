...
public class TortoiseFormStance extends AbstractStance {
    public static final String STANCE_ID = "TortoiseFormStance";
    private static final StanceStrings stanceString;
    private static long sfxId;
    private final AbstractPlayer owner;
    private final int amount;

    public TortoiseFormStance() {
        this.ID = STANCE_ID;
        this.name = STANCE_ID;
        //this.name = null;
    ...
    static {
        stanceString = CardCrawlGame.languagePack.getStanceString("TortoiseFormStance");
        sfxId = -1L;
    }
}
