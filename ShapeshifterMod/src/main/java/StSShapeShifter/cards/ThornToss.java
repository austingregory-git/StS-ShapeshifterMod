...
public class ThornToss extends AbstractDynamicCard {

    // TEXT DECLARATION

    //public static final String ID = ShapeshifterMod.makeID(${NAME}.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String ID = ShapeshifterMod.makeID("ThornToss"); // DELETE THIS ONE.
    ...
    private static final int UPGRADE_WITHER = -1;
