...
import static StSShapeShifter.ShapeshifterMod.makePowerPath;
...
public class CommonPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = ShapeshifterMod.makeID("CommonPower");
    ...
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("BurrBombPower32.png"));
