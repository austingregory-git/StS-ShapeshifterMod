...
import StSShapeShifter.cards.PantherForm;
...
public class PantherFormPower extends AbstractPower implements CloneablePowerInterface {
    ...
    private static final Texture tex84 = TextureLoader.getTexture("StSShapeShifterResources/images/powers/PantherFormPower84.png");
    private static final Texture tex32 = TextureLoader.getTexture("StSShapeShifterResources/images/powers/PantherFormPower32.png");

    public PantherFormPower(final AbstractCreature owner, int amount) {
        name = NAME;
        ID = POWER_ID;
