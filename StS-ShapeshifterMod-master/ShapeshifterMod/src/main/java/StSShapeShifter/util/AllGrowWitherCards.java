...
public class AllGrowWitherCards {
    public static ArrayList<AbstractCard> getAllGrowCards() {
        ArrayList<AbstractCard> allForms = new ArrayList<AbstractCard>(Arrays.asList(new AdaptiveStrikes(), new BarkSkin(), new BladeOfGrass(), new BloomingSlash(),
    ...
    public static ArrayList<AbstractCard> getAllWitherCards() {
        ArrayList<AbstractCard> allForms = new ArrayList<AbstractCard>(Arrays.asList(new Consume(), new CursedApple(), new Earthquake(), new FallingLeaves(),
