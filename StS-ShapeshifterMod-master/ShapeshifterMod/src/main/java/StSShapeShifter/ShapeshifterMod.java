...
public class ShapeshifterMod implements
    ...
    public void receiveEditRelics() {
        ...
        // Of note is that the bard mod uses it's own custom relic class (not dissimilar to our AbstractShapeShifterCard class for cards) that adds the 'color' field,
