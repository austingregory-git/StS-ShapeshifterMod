...
import static StSShapeShifter.ShapeshifterMod.makeOrbPath;

public class DefaultOrb extends AbstractOrb {

    // Standard ID/Description
    public static final String ORB_ID = ShapeshifterMod.makeID("DefaultOrb");
